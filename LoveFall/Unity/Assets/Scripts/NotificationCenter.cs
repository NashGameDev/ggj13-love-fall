    ...
    public static NotificationCenter DefaultCenter {
		get {
			if (defaultCenter == null)
				defaultCenter = FindObjectOfType( typeof( NotificationCenter ) ) as NotificationCenter;
			
			if(defaultCenter == null) {
				
				GameObject notificationObject = new GameObject ("Default Notification Center");
 				
				defaultCenter = notificationObject.AddComponent( typeof(NotificationCenter) ) as NotificationCenter;
			}
